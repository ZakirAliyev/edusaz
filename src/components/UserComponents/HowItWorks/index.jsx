      ...
      <div className="hiw-inner">
        <div className="hiw-header">
          ...
          <h2 className="hiw-title">
            {t('howItWorks.titlePart1')} <span className="hiw-title-colored">{t('howItWorks.titlePart2')}</span>
          </h2>
        </div>
        ...
        <div className="hiw-steps">
          <div className="hiw-step">
            ...
            <div className="step-content">
              ...
              <p className="step-desc">{t('howItWorks.step1.desc')}</p>
            </div>
          </div>
          ...
          <div className="hiw-step">
            ...
            <div className="step-content">
              ...
              <p className="step-desc">{t('howItWorks.step2.desc')}</p>
            </div>
          </div>
          ...
          <div className="hiw-step">
            ...
            <div className="step-content">
              ...
              <p className="step-desc">{t('howItWorks.step3.desc')}</p>
            </div>
          </div>
        </div>

        <div className="hiw-action">
          <button className="btn-start" onClick={() => navigate('/ai-discovery')}>
            {t('howItWorks.button')} <ArrowRightIcon />
          </button>
        </div>
      </div>
    </section>
